...
import { buildPublicHost, DEFAULT_ADMIN_URL, DEFAULT_CADDY_SERVER, openUrl, registerCaddyRoute, resolveProjectName, unregisterCaddyRoute, } from "./index.js";
...
async function runDevServer(options, command, argsForPort) {
...
async function registerRoute(options, publicHost, upstreamDial, childCommand, childArgs) {
    try {
...
function parseInstallCaddyArgs(args) {
    const options = {
...
function printInstallCaddyHelp() {
